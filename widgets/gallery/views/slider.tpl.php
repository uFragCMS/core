<div id="gallery_Carousel<?php echo $id ?>" class="carousel slide" data-ride="carousel">
	<div class="carousel-inner">
		...
		<div class="carousel-item<?php echo !isset($active) ? $active = ' active' : '' ?>">
			<a href="<?php echo url('gallery/image/'.$image['image_id'].'/'.url_title($image['title'])) ?>"><img class="d-block w-100" src="<?php echo uFrag()->model2('file', $image['file_id'])->path() ?>" data-toggle="tooltip" title="<?php echo $image['title'] ?>" alt="" /></a>
		</div>
		<?php endforeach ?>
	</div>
