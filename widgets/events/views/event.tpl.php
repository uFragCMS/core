<?php if ($image_id): ?>
<a href="<?php echo $link = url('events/'.$event_id.'/'.url_title($title)) ?>"><img src="<?php echo uFrag()->model2('file', $image_id)->path() ?>" class="img-fluid" alt="" /></a>
<?php endif ?>
<div class="card-body">
		...
		<div class="row no-gutters align-items-center">
			<div class="text-right col-5">
				<h6 class="m-0">
					...
					<?php if ($icon = uFrag()->model2('file', $match['team']['icon_id'])->path()) echo '<img src="'.uFrag()->model2('file', $icon)->path().'" style="margin-right: 10px;" alt="" />' ?>
