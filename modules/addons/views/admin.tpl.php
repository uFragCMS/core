...
<div id="addons" class="row">
	<?php foreach ($addons as $addon): ?>
		<div class="col-12 col-xl-2 col-lg-3 col-md-4 col-sm-4 mix <?php echo ($addon->type ? 'addon-'.$addon->type->name : 'addon').' '.($addon->addon()->is_enabled() ? 'activated' : 'deactivated') ?>">
			<div class="card">
				<div class="card-body">
					<div class="dropdown">
						<button class="fas fa-cog dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"></button>
