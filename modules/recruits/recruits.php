...
class Recruits extends Module
{
	...
	public function permissions()
	{
		return [
			...
			'recruit' => [
				'get_all' => function(){
					return uFrag()->db->select('recruit_id', 'CONCAT_WS(" ", "Offre", title)')->from('nf_recruits')->get();
				},
				'check' => function($recruit_id){
					if (($recruit = uFrag()->db->select('title')->from('nf_recruits')->where('recruit_id', $recruit_id)->row()) !== [])
					{
