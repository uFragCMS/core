<?php if ($image_id): ?>
<a href="<?php echo url('teams/'.$team_id.'/'.url_title($name)) ?>"><img class="card-img" src="<?php echo uFrag()->model2('file', $image_id)->path() ?>" alt=""></a>
<?php endif ?>
<div class="card-body">
	<div class="row align-items-center">
		<?php if ($icon_id): ?>
		<div class="col-2">
			<img class="img-fluid rounded" src="<?php echo uFrag()->model2('file', $icon_id)->path() ?>" alt="">
		</div>
		<?php endif ?>
